			...
			<div class="panel-body">
				...
				<form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url();?>admin/categories/add_category/<?php if(!empty($cat)) echo $cat[0]['ID']?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea class="form-control" id="field-ta" placeholder="Category Description"  name="description"><?php if(!empty($cat)) echo $cat[0]['description']; ?></textarea>
						</div>
					</div>
                    
                    <div class="form-group">
						<label for="field-1" class="col-sm-3 control-label" >Category Order No</label>
						
						<div class="col-sm-5">
							<input type="number" class="form-control" id="field-1" name="orderNo" value="<?php if(!empty($cat)) echo $cat[0]['orderNo']; ?>" placeholder="Order">
						</div>
					</div>
						...
						<div class="col-sm-5">
							<input type="file" class="form-control" id="field-file" placeholder="Category Image" name="fileAttachement">
							<?php if(!empty($cat)) { ?> 
