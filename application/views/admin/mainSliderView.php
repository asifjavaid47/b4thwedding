...
<br />
<br />
<a href="<?php echo base_url();?>admin/addMainSliderImages" class="btn btn-primary">
...
<table class="table table-bordered datatable" id="table-1">
	...
	<tbody>
	<?php 
        if(!empty($showMainSliderImages)){
		foreach($showMainSliderImages as $allcat)
		{
	?>
		<tr class="odd gradeX">
			<td><?php echo $allcat['cName']; ?></td>
			<td><?php echo $allcat['description']; ?></td>
			<td><img style="width: 100px;height: 100px;" src="<?=base_url();?>public/upload/sliderImagesUpload/<?php echo $allcat['imagePath']; ?>"></td>
			<td class="center"><a href="<?php echo base_url() . "admin/frontEndManagement/deleteMainSliderImages/" . $allcat['ID']; ?>" >Delete</a> / <a href="<?php echo base_url() . "admin/frontEndManagement/addMainSliderImages/" . $allcat['ID']; ?>" >Update</a></td>
		</tr>
	<?php 
		}
        }
