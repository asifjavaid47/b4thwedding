...
<div class="row">
	<div class="col-sm-3">
		...
		<div class="tile-stats tile-red">
			...
			<div class="num" data-start="0" data-end="83" data-postfix="" data-duration="1500" data-delay="0"><?php if(!empty($totalUsers)) { echo $totalUsers;} else { echo"0";} ?></div>
	...
	<div class="col-sm-3">
		...
		<div class="tile-stats tile-green">
			...
			<div class="num" data-start="0" data-end="135" data-postfix="" data-duration="1500" data-delay="600"><?php if(!empty($totalUsers)) { echo $totalProject; } else { echo"0";} ?></div>
	...
	<div class="col-sm-3">
		...
		<div class="tile-stats tile-aqua">
			...
			<div class="num" data-start="0" data-end="23" data-postfix="" data-duration="1500" data-delay="1200"><?php if(!empty($totalMessage)) { echo $totalMessage; } else { echo"0";} ?></div>
	...
	<div class="col-sm-3">
		...
		<div class="tile-stats tile-blue">
			...
			<div class="num" data-start="0" data-end="52" data-postfix="" data-duration="1500" data-delay="1800"><?php if(!empty($totalCancelDispute)) { echo $totalCancelDispute; } else { echo"0";} ?></div>
			
			<h3>Cancel Dispute</h3>
			<p>Total Cancel Dispute.</p>
		</div>
...
<div class="row">
	...
	<div class="col-sm-12">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="panel-title">Latest Withdraw history</div>
	...
	?>
		<tr class="odd gradeX">
			...
			<td><?php if($allpro['status'] == 1) echo 'Approved'; else echo 'Pending'; ?></td>
