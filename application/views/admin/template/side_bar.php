...
<li>
	...
	<li>
		<a href="#"><i class="entypo-newspaper"></i><span>Categories</span></a>
...
<!--		<li>
		...
		<li>
			<a href="<?php echo base_url(); ?>admin/show_category"><span>Manage Categories</span></a>
		</li>
		<li>
			<a href="<?php echo base_url(); ?>admin/show_sub_category"><span>Manage Skills</span></a>
		</li>
...
<li>
		...
		<ul>
				...
				<li>
					<a href="<?php echo base_url(); ?>admin/commissionSettings"><span>Commission Setting</span></a>
				</li>
				<!--<li>
					<a href="<?php echo base_url(); ?>admin/showCencellationReason"><span>Project Cancellation Reason</span></a>
				</li>-->
...
<li>
		<a href="#"><i class="entypo-newspaper"></i><span>Account Settings</span></a>

		<ul>

				<li>
					<a href="<?php echo base_url(); ?>admin/changePassword"><span>Change Password</span></a>
				</li>
...
<li>
		<a href="#"><i class="entypo-newspaper"></i><span>Admin</span></a>

		<ul>

				<li>
					<a href="<?php echo base_url(); ?>admin/showAdminList"><span>View Admin</span></a>
				</li>
				<li>
					<a href="<?php echo base_url(); ?>admin/addSubAdmin"><span>Create New Admin</span></a>
				</li>
