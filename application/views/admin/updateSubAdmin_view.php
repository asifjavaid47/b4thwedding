	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url();?>admin/admin/updateSubAdmin/<?php echo $id; ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="first_name" value="<?php echo $adminInfo[0]['first_name']; ?>" required>
						</div>
					</div>
                    ...
                    <div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="last_name" value="<?php echo $adminInfo[0]['last_name']; ?>" required >
						</div>
					</div>
                    ...
                    <div class="form-group">
						...
						<div class="col-sm-5">
							<input type="email" class="form-control" id="field-1" name="email_address" value="<?php echo $adminInfo[0]['email_addres']; ?>" required >
						</div>
					</div>
                    ...
                    <div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="user_name"value="<?php echo $adminInfo[0]['user_name']; ?>" readonly="readonly">
