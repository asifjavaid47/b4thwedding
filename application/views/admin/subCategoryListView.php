...
<br />
<a href="<?php echo base_url(); ?>admin/add_sub_category" class="btn btn-primary">
...
<table class="table table-bordered datatable" id="table-1">
	...
	?>
		<tr class="odd gradeX">
			<td><?php echo $allcat['skillName']; ?></td>
			<td class="center"><a href="<?php echo base_url() . "admin/categories/delete_sub_category/" . $allcat['ID']; ?>" >Delete</a> / <a href="<?php echo base_url() . "admin/categories/add_sub_category/" . $allcat['ID']; ?>" >Update</a></td>
		</tr>
	<?php 
		}
        }
