        ...
        <div class="clear20"></div>
          ...
          <div class="inbox_left" style="width:100%; border-radius:0; margin:0;">
                <ul>
                    ...
                    <li><a href="<?php echo base_url(); ?>users/<?php echo $freelancerView; ?>"><span>Overview </span></a></li>
                    
                    <?php /*?> <li><a href="<?php echo base_url(); ?>project/my_jobs_c"><span>Job History </span></a></li><?php */?>
                </ul>
            </div>
             <div class="clear10"></div>
          <div class="inbox_left" style="width:100%; border-radius:0; margin:0;">
...
<div class="right_box_pro">
          <!-- <h4 style="margin:0; padding:0;">My Snapshot </h4>
           <div class="clear20"></div>
            ...
            <div class="clear"></div>
             ...
             <div>
		<div class="snapshot-item-title">Jobs</div>
		<div class="snapshot-item-value">
			<div id="snapshot-12mo-1">
				<a href="#"><?php echo $totalJobs; ?></a><br>
				<!--<a href="#">0</a><br>
				<a  href="#">0</a>-->
			</div>
    ...
    <div>
		<div class="snapshot-item-title">Reviews</div>
		<div class="snapshot-item-value">
			<div id="snapshot-12mo-1">
				<?php echo $ratingCount; ?><br>
				<!--<a href="#">N/A</a><br>-->
...
<!--<div class="right_box_pro">
       ...
       <div class="clear"></div>  
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<b><?php echo $rat['title']; ?> </b>(Not visible to public)</p>
            </div>

<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 pull-left">
        	<strong>My rating for this job</strong>
        </div>
       <div class="col-lg-4 col-md-4 col-xs-8 col-sm-8 pull-left"><h5>Freelancer: <?php echo $rat['fName']; ?></h5></div>
    ...
    <div class="col-lg-12 col-md-12 ol-xs-12 col-sm-12 pull-left">
    	<div class="rating-enable input select rating-c padding0 col-lg-2 col-md-2 ol-xs-12 col-sm-12">
                        ...
                        <div class="col-lg-4 col-md-3 ol-xs-12 col-sm-12 pull-left padding0">Feedback Comments:</div>
   ...
   <div class="col-lg-12 col-md-12 ol-xs-12 col-sm-12 pull-left">
    ...
    <div class="col-lg-12 col-md-12 ol-xs-12 col-sm-12 pull-left">
    	<div class="rating-enable input select rating-c col-lg-2 col-md-2 ol-xs-12 col-sm-12 padding0">
                         ...
                         <div class="col-lg-4 col-md-3 ol-xs-12 col-sm-12 pull-left padding0">Freelancer Feedback Comments for Client:</div> 
                         <?php } ?> 
