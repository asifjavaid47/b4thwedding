...
<div id="wrap">
   	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 inner_content">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 inner_hdng">Wedding Contractor Account</div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 inner_social"><a href="javascript:" class="facebookSignup"><img src="<?= base_url(); ?>public/images/popup_fb_icon.png" alt=""></a> &nbsp;&nbsp;<a href="<?=base_url()?>liConnect/lilogin"><img src="<?= base_url(); ?>public/images/popup_in_icon.png" alt=""></a></div>
            
            <div class="inner_project_form">
            <form action="<?=base_url();?>users/createFreelancerUser" method="post" enctype="multipart/form-data">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding_tb40">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding0 inner_project_form_txt2">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding0">
                        <input type="radio" name="accountType" class="frm_inpt" value="individual" required="">&nbsp; Individual 
                     </div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding0">
                        <input type="radio" name="accountType" class="frm_inpt" value="company" required="">&nbsp; Company 
                     </div>
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding0 inner_project_form_txt">
...
<!--                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding0">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-11 padding0">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 inner_project_form_txt">By clicking, you agree to our <a href="<?=base_url()?>page/independentContractorAgreement">b4thewedding User Agreement</a></div>
