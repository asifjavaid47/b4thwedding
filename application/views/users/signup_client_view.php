...
<div id="wrap">
   	    ...
   	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 inner_content">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 inner_sbbhdng">Already have an account? <a href="#" class="post">Sign In</a>. Looking to hire? <a href="<?= base_url()?>users/signup/freelancer">Register as a Wedding Contractor</a>.</div>
            ...
            <form action="<?=base_url();?>users/create_client" method="post" enctype="multipart/form-data">
