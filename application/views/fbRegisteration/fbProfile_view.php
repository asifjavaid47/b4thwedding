...
<div id="wrap">
           ...
           <?php echo form_open_multipart(base_url().'fbProfile/completeProfile'); ?>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding_tb40">
                  	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding0 inner_project_form_txt">
                    	First Name <input type="text" name="fName" id="fName" class="frm_inpt signup_input" value="<?php echo ($this->session->userdata('fName'))?$this->session->userdata('fName'):'';?>" >
                    </div>
                  	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding0 inner_project_form_txt">
                    	Last Name <input type="text" name="lName"  id="lName" value="<?php echo ($this->session->userdata('lName'))?$this->session->userdata('lName'):'';?>" class="frm_inpt" >
                     </div>
                  	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding0 inner_project_form_txt">
                    Email Address (See our strict <a href="#">Privacy Policy</a>.)
