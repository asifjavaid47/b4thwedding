              ...
              <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 padding0 inner_project_form_txt"  style="clear: both;">
                  ...
                  <select name="fixedBudget" id="fixedBudget" class="frm_slct" required="">
					...
					<div class="hrperweek_duration_holder">					
                    	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 padding0 inner_project_form_txt" style="clear: both; display:none">
                    ...
                    <select type="text" name="duration" id="duration" class="frm_slct" style="display:none">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-11 padding0">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 inner_sbbhdng2">We value your privacy. <a href="<?=base_url()?>page/privacyPolicy">Privacy Policy</a> &nbsp; <img alt="" src="<?=base_url()?>public/images/lock_icon.png"></div>
                </div>
                </div>
                </form>  
