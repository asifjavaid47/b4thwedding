	...
	<!--choose dropdown start-->				 
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-11 col-xs-offset-2">
              ...
              <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 padding0 inner_project_form_txt">
                    	...
                    	<option value="hourly" <?php if($project[0]['workType']=='hourly'){ echo 'selected="selected"';}?>>hourly</option>
                        <option value="fixedPrice" <?php if($project[0]['workType']=='fixedPrice'){ echo 'selected="selected"';}?>>Fixed Price</option>
                    </select>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 padding0 inner_project_form_txt fixedBudgetHolder" style="display:none"  >
		...
		<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 padding0 inner_project_form_txt" style="clear: both; margin-left:13px">
				<input type="text" name="hrsPerWeeks" value="<?php echo $project[0]['hrsPerWeeks']; ?>" id="hrsPerWeeks" class="frm_inpt_hrs" required=""><span class="hrs-wek">hrs/week</span>
		</div>
 ...
 <script>
  ...
  $("#workType").change(function(){
    ...
    function change_amount_custom(value){
        if(value != ''){
            $('form select[name=fixedBudget]').replaceWith('<input type="number" name="fixedBudget" id="fixedBudget" value="'+value+'" class="frm_inpt" placeholder="Enter Amount">');
            return;
        }
    }
    $(document).ready(function(){
