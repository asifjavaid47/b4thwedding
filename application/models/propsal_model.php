...
public function get_projectDetail($ID){
					...
					$query .= "tbl_project_posts.postDate,tbl_project_posts.duration,tbl_project_posts.skills,tbl_project_posts.states,";
					$query .= "tbl_project_posts.hourlyRate,tbl_project_posts.hrsPerWeeks,tbl_project_posts.userID,";
					$query.= "tbl_project_posts.workType,tbl_project_posts.fixedBudget,tbl_users.country ,";
					$query.= "tbl_project_posts.finishProject ,tbl_project_posts.awardStatus,";
						...
						if ($query->num_rows() > 0)
						{
							$rows = $query->result_array();
						   				$data = array(
												...
												"title"         => $rows[0]['title'],
												"awardStatus"   => $rows[0]['awardStatus'],
