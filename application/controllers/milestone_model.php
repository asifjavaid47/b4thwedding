...
public function getMilestone($ID){
    ...
    public function getAwardedDetail($projectID) {
        ...
        $query .= "tbl_proposal.estimateDilieveryDate as delivery_date,tbl_proposal.myEarning as total_amount,";
        ...
        $query .= "Where tbl_awarded.awardedJobId = $projectID AND tbl_proposal.projectId = $projectID AND  tbl_proposal.awarded = 'awarded' ";
